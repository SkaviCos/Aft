...
public class BasePage {
    ...
    public void tap(WebElement element) {
        new TouchAction(driver).tap(PointOption.point(element.getLocation().getX(), element.getLocation().getY()))
                .perform();
    }
...
//    }
    ...
    public void scrollDown() {
        ...
        PointOption option = new PointOption().withCoordinates(5, height * 2 / 3);
        new TouchAction(driver).press(option)
                .waitAction(WaitOptions.waitOptions(Duration.ofMillis(1000)))
                .moveTo(PointOption.point(5, height / 3))
                .release().perform();
    ...
    public void scrollUp() {
        ...
        new TouchAction(driver).press(PointOption.point(5, height / 3))
                .waitAction(WaitOptions.waitOptions(Duration.ofMillis(1000)))
                .moveTo(PointOption.point(5, height * 2 / 3))
                .release().perform();
    }
